...
class CategoryTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Tutorboy\Blogmaster\Domain\Model\Category
	 */
	protected $fixture = null;

	protected function setUp() {
		$this->fixture = new \Tutorboy\Blogmaster\Domain\Model\Category();
	}
	...
	public function setParentSetsParent() {
		$parent = new \Tutorboy\Blogmaster\Domain\Model\Category();
